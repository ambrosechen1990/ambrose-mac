"""
200070 验证密码为纯小写字母时，下一步按钮不可点击（Android）。

  步骤：进入密码页验证（验证密码为纯小写字母时，下一步按钮不可点击）。
"""
...
def test_200070(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200070_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200070",
            case_desc='200070 验证密码为纯小写字母时，下一步按钮不可点击',
            result=case_result,
