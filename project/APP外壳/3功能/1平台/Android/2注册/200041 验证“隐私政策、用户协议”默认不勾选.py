"""
200041 验证隐私政策、用户协议默认不勾选（Android）。
...
def test_200041(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200041_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200041",
            case_desc='200041 验证隐私政策、用户协议默认不勾选',
            result=case_result,
