"""
200085 验证"Personal Information"页面显示（Android）。
...
def test_200085(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200085_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200085",
            case_desc='200085 验证"Personal Information"页面显示',
            result=case_result,
