"""
200030 验证注册页面国家切换-搜索一个不存在的国家（Android）。
...
def test_200030(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200030_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200030",
            case_desc='200030 验证注册页面国家切换-搜索一个不存在的国家',
            result=case_result,
