"""
200067 验证密码等于6个字符时，下一步按钮可点击（Android）。

  步骤：进入密码页验证（验证密码等于6个字符时，下一步按钮可点击）。
"""
...
def test_200067(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200067_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200067",
            case_desc='200067 验证密码等于6个字符时，下一步按钮可点击',
            result=case_result,
