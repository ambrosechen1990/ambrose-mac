...
def test_200025(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200025_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200025",
            case_desc='200025 验证APP首页注册功能按钮',
            result=case_result,
