"""
200042 验证"隐私政策、用户协议"勾选功能（Android）。
...
def test_200042(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200042_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200042",
            case_desc='200042 验证"隐私政策、用户协议"勾选功能',
            result=case_result,
