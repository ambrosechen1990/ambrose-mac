"""
200080 验证输入的密码，可以一键×清空（Android）。
...
def test_200080(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200080_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200080",
            case_desc='200080 验证输入的密码，可以一键×清空',
            result=case_result,
