"""
200040 验证注册地为"中国"以外地区，正确邮箱，可以注册（Android）。
...
def test_200040(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200040_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200040",
            case_desc='200040 验证注册地为"中国"以外地区，正确邮箱，可以注册',
            result=case_result,
