"""
200058 验证错误邮箱，无法进行下一步操作-a@b（Android）。

  步骤：输入错误邮箱 'a@b'，断言无法下一步。
"""
...
def test_200058(setup_driver):
    ...
    try:
        ...
        bad = 'a@b' or os.environ.get("INVALID_EMAIL", "")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200058_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200058",
            case_desc='200058 验证错误邮箱，无法进行下一步操作-a@b',
            result=case_result,
