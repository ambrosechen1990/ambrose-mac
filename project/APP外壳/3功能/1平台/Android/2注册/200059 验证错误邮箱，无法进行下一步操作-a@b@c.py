"""
200059 验证错误邮箱，无法进行下一步操作-a@b@c（Android）。

  步骤：输入错误邮箱 'a@b@c.com'，断言无法下一步。
"""
...
def test_200059(setup_driver):
    ...
    try:
        ...
        bad = 'a@b@c.com' or os.environ.get("INVALID_EMAIL", "")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200059_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200059",
            case_desc='200059 验证错误邮箱，无法进行下一步操作-a@b@c',
            result=case_result,
