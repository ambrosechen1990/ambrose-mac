"""
200022 验证注册时邮箱显示包含特殊字符（Android）。
...
def test_200022(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200022_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200022",
            case_desc='200022 验证注册时邮箱显示包含特殊字符',
            result=case_result,
