"""
200028 验证注册页面国家切换-选择列表中的国家（Android）。
...
def test_200028(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200028_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200028",
            case_desc='200028 验证注册页面国家切换-选择列表中的国家',
            result=case_result,
