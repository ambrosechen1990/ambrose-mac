"""
200045 验证只填写正确邮箱，Next按钮还是浅色不可点击（Android）。
...
def test_200045(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200045_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200045",
            case_desc='200045 验证只填写正确邮箱，Next按钮还是浅色不可点击',
            result=case_result,
