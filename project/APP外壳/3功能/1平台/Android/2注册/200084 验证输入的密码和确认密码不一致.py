"""
200084 验证输入的密码和确认密码不一致（Android）。
...
def test_200084(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200084_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200084",
            case_desc='200084 验证输入的密码和确认密码不一致',
            result=case_result,
