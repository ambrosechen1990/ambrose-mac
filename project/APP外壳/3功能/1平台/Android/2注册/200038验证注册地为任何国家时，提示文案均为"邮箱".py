"""
200038 验证注册地为任何国家时，提示文案均为"邮箱"（Android）。
...
def test_200038(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200038_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200038",
            case_desc='200038 验证注册地为任何国家时，提示文案均为"邮箱"',
            result=case_result,
