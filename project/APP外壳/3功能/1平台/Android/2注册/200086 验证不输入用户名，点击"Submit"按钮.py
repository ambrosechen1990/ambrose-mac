"""
200086 验证不输入用户名，点击"Submit"按钮（Android）。
...
def test_200086(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200086_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200086",
            case_desc='200086 验证不输入用户名，点击"Submit"按钮',
            result=case_result,
