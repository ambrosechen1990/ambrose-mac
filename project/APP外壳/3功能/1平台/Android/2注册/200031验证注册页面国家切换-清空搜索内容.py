"""
200031 验证注册页面国家切换-清空搜索内容（Android）。
...
def test_200031(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200031_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200031",
            case_desc='200031 验证注册页面国家切换-清空搜索内容',
            result=case_result,
