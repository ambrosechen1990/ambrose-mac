"""
200057 验证错误邮箱，无法进行下一步操作-只有点（Android）。

  步骤：输入错误邮箱 'a.b.c'，断言无法下一步。
"""
...
def test_200057(setup_driver):
    ...
    try:
        ...
        bad = 'a.b.c' or os.environ.get("INVALID_EMAIL", "")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200057_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200057",
            case_desc='200057 验证错误邮箱，无法进行下一步操作-只有点',
            result=case_result,
