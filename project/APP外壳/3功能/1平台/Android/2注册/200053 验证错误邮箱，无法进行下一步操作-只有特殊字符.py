"""
200053 验证错误邮箱，无法进行下一步操作-只有特殊字符（Android）。
...
def test_200053(setup_driver):
    ...
    try:
        ...
        bad = '!@#$%^&*' or os.environ.get("INVALID_EMAIL", "")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200053_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200053",
            case_desc='200053 验证错误邮箱，无法进行下一步操作-只有特殊字符',
            result=case_result,
