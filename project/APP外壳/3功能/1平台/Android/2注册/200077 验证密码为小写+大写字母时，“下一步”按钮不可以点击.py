"""
200077 验证密码为小写+大写字母时，下一步按钮不可以点击（Android）。

  步骤：进入密码页验证（验证密码为小写+大写字母时，下一步按钮不可以点击）。
"""
...
def test_200077(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200077_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200077",
            case_desc='200077 验证密码为小写+大写字母时，下一步按钮不可以点击',
            result=case_result,
