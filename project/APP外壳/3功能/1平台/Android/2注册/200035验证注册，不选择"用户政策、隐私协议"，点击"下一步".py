"""
200035 验证注册，不选择用户政策、隐私协议，点击"下一步"（Android）。
...
def test_200035(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200035_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200035",
            case_desc='200035 验证注册，不选择用户政策、隐私协议，点击"下一步"',
            result=case_result,
