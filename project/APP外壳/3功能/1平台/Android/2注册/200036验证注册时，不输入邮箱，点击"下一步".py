"""
200036 验证注册时，不输入邮箱，点击"下一步"（Android）。
...
def test_200036(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200036_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200036",
            case_desc='200036 验证注册时，不输入邮箱，点击"下一步"',
            result=case_result,
