...
def test_200083(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200083_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200083",
            case_desc='200083 验证密码明文后，可以再次隐藏',
            result=case_result,
