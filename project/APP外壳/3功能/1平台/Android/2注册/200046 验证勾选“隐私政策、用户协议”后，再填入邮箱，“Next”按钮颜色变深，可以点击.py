"""
200046 验证勾选协议后填入邮箱，Next可点击并进入密码页（Android）。
...
def test_200046(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200046_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200046",
            case_desc='200046 验证勾选协议后填入邮箱，Next可点击并进入密码页',
            result=case_result,
