"""
200024 验证输入用户名名字49个字符，点击Submit按钮（Android）。
...
def test_200024(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200024_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200024",
            case_desc='200024 验证输入用户名名字49个字符，点击Submit按钮',
            result=case_result,
