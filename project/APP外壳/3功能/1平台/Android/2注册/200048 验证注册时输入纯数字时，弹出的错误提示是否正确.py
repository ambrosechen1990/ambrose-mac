"""
200048 验证注册时输入纯数字时，弹出的错误提示是否正确（Android）。
...
def test_200048(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200048_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200048",
            case_desc='200048 验证注册时输入纯数字时，弹出的错误提示是否正确',
            result=case_result,
