"""
200044 验证"Next"按钮，初始状态为浅色，不可点击（Android）。
...
def test_200044(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200044_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200044",
            case_desc='200044 验证"Next"按钮，初始状态为浅色，不可点击',
            result=case_result,
