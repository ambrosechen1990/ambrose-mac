"""
200033 验证从国家列表取消，返回注册主页面（Android）。
...
def test_200033(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200033_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200033",
            case_desc='200033 验证从国家列表取消，返回注册主页面',
            result=case_result,
