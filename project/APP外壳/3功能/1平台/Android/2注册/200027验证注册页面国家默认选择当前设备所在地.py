"""
200027 验证注册页面国家默认选择当前设备所在地（Android）。
...
def test_200027(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200027_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200027",
            case_desc='200027 验证注册页面国家默认选择当前设备所在地',
            result=case_result,
