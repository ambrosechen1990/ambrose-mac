"""
200049 验证邮箱数字+字母，无法下一步（Android）。
...
def test_200049(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200049_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200049",
            case_desc='200049 验证邮箱数字+字母，无法下一步',
            result=case_result,
