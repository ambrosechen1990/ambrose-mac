"""
200054 验证错误邮箱，无法进行下一步操作-包含中文（Android）。

  步骤：输入错误邮箱 '测试@163.com'，断言无法下一步。
"""
...
def test_200054(setup_driver):
    ...
    try:
        ...
        bad = '测试@163.com' or os.environ.get("INVALID_EMAIL", "")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200054_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200054",
            case_desc='200054 验证错误邮箱，无法进行下一步操作-包含中文',
            result=case_result,
