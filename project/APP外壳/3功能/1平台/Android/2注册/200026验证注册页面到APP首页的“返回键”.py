"""
200026 验证注册页面到APP首页的返回键（Android）。
...
def test_200026(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200026_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200026",
            case_desc='200026 验证注册页面到APP首页的返回键',
            result=case_result,
