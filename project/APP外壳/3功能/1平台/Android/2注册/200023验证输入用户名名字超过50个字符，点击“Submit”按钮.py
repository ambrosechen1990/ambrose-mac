"""
200023 验证输入用户名名字超过50个字符，点击Submit按钮（Android）。
...
def test_200023(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200023_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200023",
            case_desc='200023 验证输入用户名名字超过50个字符，点击Submit按钮',
            result=case_result,
