"""
200052 验证错误邮箱，无法进行下一步操作-只有字母（Android）。

  步骤：输入错误邮箱 'abcdef'，断言无法下一步。
"""
...
def test_200052(setup_driver):
    ...
    try:
        ...
        bad = 'abcdef' or os.environ.get("INVALID_EMAIL", "")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200052_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200052",
            case_desc='200052 验证错误邮箱，无法进行下一步操作-只有字母',
            result=case_result,
