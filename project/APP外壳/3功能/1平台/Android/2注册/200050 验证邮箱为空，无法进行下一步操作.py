"""
200050 验证错误邮箱，无法进行下一步操作-邮箱为空（Android）。
...
def test_200050(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200050_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200050",
            case_desc='200050 验证错误邮箱，无法进行下一步操作-邮箱为空',
            result=case_result,
