"""
200021 验证注册时邮箱显示包含不支持的特殊字符（Android）。
...
def test_200021(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200021_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200021",
            case_desc='200021 验证注册时邮箱显示包含不支持的特殊字符',
            result=case_result,
