"""
200051 验证修改错误邮箱，错误提示就会消失（Android）。
...
def test_200051(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200051_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200051",
            case_desc='200051 验证修改错误邮箱，错误提示就会消失',
            result=case_result,
