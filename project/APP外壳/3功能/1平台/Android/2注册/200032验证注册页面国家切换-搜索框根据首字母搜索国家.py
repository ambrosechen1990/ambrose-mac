"""
200032 验证注册页面国家切换-搜索框根据首字母搜索国家（Android）。
...
def test_200032(setup_driver):
    ...
    try:
        ...
        # 对齐 iOS 102188：搜索首字母 Z，断言列表国家名均含该字母（非点击某一国）
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200032_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200032",
            case_desc='200032 验证注册页面国家切换-搜索框根据首字母搜索国家',
            result=case_result,
