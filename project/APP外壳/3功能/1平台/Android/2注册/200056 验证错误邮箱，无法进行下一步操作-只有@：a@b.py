"""
200056 验证错误邮箱，无法进行下一步操作-只有@（Android）。
...
def test_200056(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200056_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200056",
            case_desc='200056 验证错误邮箱，无法进行下一步操作-只有@',
            result=case_result,
