"""
200029 验证注册页面国家切换-搜索一个存在的国家（Android）。
...
def test_200029(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200029_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200029",
            case_desc='200029 验证注册页面国家切换-搜索一个存在的国家',
            result=case_result,
