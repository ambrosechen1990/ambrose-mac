"""
200006 验证输入邮箱，不输入密码，勾选用户协议和隐私政策，点击登录（Android）。

仅邮箱 + 勾选 + Next → Incorrect password.
"""
...
def test_200006(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200006_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200006",
            case_desc="200006 验证输入邮箱，不输入密码，勾选用户协议和隐私政策，点击登录",
            result=case_result,
