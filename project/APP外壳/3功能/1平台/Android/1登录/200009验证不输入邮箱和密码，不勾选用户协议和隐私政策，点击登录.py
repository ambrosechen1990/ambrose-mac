"""
200009 验证不输入邮箱和密码，不勾选用户协议和隐私政策，点击登录（Android）。

不输入 + Next → Please enter a valid email address.
"""
...
def test_200009(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200009_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200009",
            case_desc="200009 验证不输入邮箱和密码，不勾选用户协议和隐私政策，点击登录",
            result=case_result,
