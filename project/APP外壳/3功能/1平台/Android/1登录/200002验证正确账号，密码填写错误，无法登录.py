"""
200002 验证正确账号，密码填写错误，无法登录（Android）。
...
步骤：
  ...
  7. 勾选协议
  8. 点击 Next
  9. 断言 Incorrect account or password
"""
...
# 本用例期望的提示/断言文案
MSG_LOGIN_FAIL = "Incorrect account or password. Please check and try again."
...
def test_200002(setup_driver):
    ...
    try:
        ...
        print(f"🔄 {current_step}")
        try:
            pwd_value = os.environ.get("LOGIN_WRONG_PASSWORD", "CSX150128")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200002_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200002",
            case_desc="200002 验证正确账号，密码填写错误，无法登录",
            result=case_result,
