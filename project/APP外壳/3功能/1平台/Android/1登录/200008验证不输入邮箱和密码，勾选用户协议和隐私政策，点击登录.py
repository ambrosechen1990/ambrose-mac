"""
200008 验证不输入邮箱和密码，勾选用户协议和隐私政策，点击登录（Android）。

不输入 + 勾选 + Next → Please enter a valid email address.
"""
...
def test_200008(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200008_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200008",
            case_desc="200008 验证不输入邮箱和密码，勾选用户协议和隐私政策，点击登录",
            result=case_result,
