"""
200004 验证不输入邮箱和输入密码，勾选用户协议和隐私政策，点击登录（Android）。

仅输入密码 + 勾选协议 + Next → Please enter a valid email address.
"""
...
def test_200004(setup_driver):
    ...
    try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_200004_failed")
        ...
        write_report(
            ...
            platform="android",
            case_id="200004",
            case_desc="200004 验证不输入邮箱和输入密码，勾选用户协议和隐私政策，点击登录",
            result=case_result,
