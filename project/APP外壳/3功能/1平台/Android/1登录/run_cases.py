...
def _patch_case_module_dependencies():
    common_utils = importlib.import_module("common_utils_android")

    class _DummyLogger(logging.Logger):
        def __init__(self):
            super().__init__("dummy")

    def _dummy_init_report(run_label: str = "android"):
...
def test_android_cases(setup_driver, case_id, case_desc, run_fn):
    driver = setup_driver
