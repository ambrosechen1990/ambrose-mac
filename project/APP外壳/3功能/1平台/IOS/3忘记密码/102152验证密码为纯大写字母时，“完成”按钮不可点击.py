...
def test_102152(setup_driver):
    """
    102152 验证密码为纯大写字母时，“完成”按钮不可点击
    ...
    try:
        ...
        current_step = "步骤7: 输入纯大写字母密码(两次)并收起键盘"
        print(f"🔄 {current_step}")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102152_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102152",
            case_desc='102152 验证密码为纯大写字母时，“完成”按钮不可点击',
            result=case_result,
