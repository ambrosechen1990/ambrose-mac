...
def test_102150(setup_driver):
    """
    102150 验证密码为纯数字时，“完成”按钮不可点击
    ...
    password_value = os.environ.get("TEST_PASSWORD", '123456')
    expectations = {
    ...
    try:
        ...
        current_step = "步骤7: 输入纯数字密码(两次)并收起键盘"
        print(f"🔄 {current_step}")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102150_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102150",
            case_desc='102150 验证密码为纯数字时，“完成”按钮不可点击',
            result=case_result,
