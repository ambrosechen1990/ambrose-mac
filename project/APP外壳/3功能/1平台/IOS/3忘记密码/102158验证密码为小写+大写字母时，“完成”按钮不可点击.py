...
def test_102158(setup_driver):
    """
    102158 验证密码为小写+大写字母时，“完成”按钮不可点击
    ...
    try:
        ...
        current_step = "步骤7: 输入大小写字母混合密码(两次)并收起键盘"
        print(f"🔄 {current_step}")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102158_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102158",
            case_desc='102158 验证密码为小写+大写字母时，“完成”按钮不可点击',
            result=case_result,
