...
def test_102151(setup_driver):
    """
    102151 验证密码为纯小写字母时，“完成”按钮不可点击
    ...
    try:
        ...
        current_step = "步骤7: 输入纯小写字母密码(两次)并收起键盘"
        print(f"🔄 {current_step}")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102151_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102151",
            case_desc='102151 验证密码为纯小写字母时，“完成”按钮不可点击',
            result=case_result,
