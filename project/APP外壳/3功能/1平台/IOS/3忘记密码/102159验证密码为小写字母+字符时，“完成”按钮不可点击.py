...
def test_102159(setup_driver):
    """
    102159 验证密码为小写字母+字符时，“完成”按钮不可点击
    ...
    try:
        ...
        current_step = "步骤7: 输入小写字母+特殊字符密码(两次)并收起键盘"
        print(f"🔄 {current_step}")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102159_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102159",
            case_desc='102159 验证密码为小写字母+字符时，“完成”按钮不可点击',
            result=case_result,
