...
def test_102160(setup_driver):
    """
    102160 验证密码为大写字母+字符时，“完成”按钮不可点击
    ...
    try:
        ...
        current_step = "步骤7: 输入大写字母+特殊字符密码(两次)并收起键盘"
        print(f"🔄 {current_step}")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102160_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102160",
            case_desc='102160 验证密码为大写字母+字符时，“完成”按钮不可点击',
            result=case_result,
