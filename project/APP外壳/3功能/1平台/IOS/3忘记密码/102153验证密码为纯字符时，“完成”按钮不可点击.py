...
def test_102153(setup_driver):
    """
    102153 验证密码为纯字符时，“完成”按钮不可点击
    ...
    password_value = os.environ.get("TEST_PASSWORD", "!@#$%^&*()-==+\\'l[};:/?...~><`")
    expectations = {
    ...
    try:
        ...
        current_step = "步骤7: 输入纯特殊字符密码(两次)并收起键盘"
        print(f"🔄 {current_step}")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102153_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102153",
            case_desc='102153 验证密码为纯字符时，“完成”按钮不可点击',
            result=case_result,
