...
def _click_with_tap_fallback(driver, selectors, timeout_each: int = 6):
    """
    iOS 真机上 element_to_be_clickable 容易超时，使用 presence + click，
    click 失败时用 mobile: tap 坐标兜底。
    """
    elem = None
