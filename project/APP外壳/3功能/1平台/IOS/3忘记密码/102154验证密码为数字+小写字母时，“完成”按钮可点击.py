...
def test_102154(setup_driver):
    """
    102154 验证密码为数字+小写字母时，“完成”按钮可点击
    ...
    password_value = os.environ.get("TEST_PASSWORD", 'xingmai123456')
    ...
    try:
        ...
        current_step = "步骤7: 输入数字+小写字母密码(两次)并收起键盘"
        print(f"🔄 {current_step}")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102154_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102154",
            case_desc='102154 验证密码为数字+小写字母时，“完成”按钮可点击',
            result=case_result,
