...
def test_102155(setup_driver):
    """
    102155 验证密码为数字+大写字母时，“完成”按钮可点击
    ...
    try:
        ...
        current_step = "步骤7: 输入数字+大写字母密码(两次)并收起键盘"
        print(f"🔄 {current_step}")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102155_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102155",
            case_desc='102155 验证密码为数字+大写字母时，“完成”按钮可点击',
            result=case_result,
