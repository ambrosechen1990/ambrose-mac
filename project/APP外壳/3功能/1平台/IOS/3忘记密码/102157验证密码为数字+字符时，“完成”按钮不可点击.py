...
def test_102157(setup_driver):
    """
    102157 验证密码为数字+字符时，“完成”按钮不可点击
    ...
    password_value = os.environ.get("TEST_PASSWORD", "!@#$%^&*()-==+\\'l[};:/?...~><`12")
    expectations = {
    ...
    try:
        ...
        current_step = "步骤7: 输入数字+特殊字符密码(两次)并收起键盘"
        print(f"🔄 {current_step}")
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102157_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102157",
            case_desc='102157 验证密码为数字+字符时，“完成”按钮不可点击',
            result=case_result,
