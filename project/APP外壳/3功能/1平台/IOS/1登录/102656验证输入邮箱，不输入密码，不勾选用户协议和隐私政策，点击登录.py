...
def test_102656(setup_driver):
    """
    验证输入邮箱，不输入密码，不勾选用户协议和隐私政策，点击登录
    ...
    try:
        ...
        # 步骤5: 验证密码输入框为空（不输入密码）
        current_step = "步骤5: 验证密码输入框为空（不输入密码）"
        print(f"🔄 {current_step}")
        try:
            # 验证密码输入框为空
        ...
        # 步骤6: 点击登录按钮（不勾选用户协议和隐私政策，不输入密码）
        current_step = "步骤6: 点击登录按钮（不勾选用户协议和隐私政策，不输入密码）"
        print(f"🔄 {current_step}")
        try:
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102656_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102656",
            case_desc="验证输入邮箱，不输入密码，不勾选用户协议和隐私政策，点击登录",
            result=case_result,
