    ...
    try:
        ...
        try:
            ...
            try:
                ...
                generic_back_buttons = driver.find_elements(AppiumBy.XPATH, '//XCUIElementTypeButton[contains(@name, "Back") or contains(@name, "返回") or contains(@name, "nav")]')
        ...
        try:
            ...
            print(f"✅ {current_step} - 完成，已成功返回APP首页")
        except Exception as e:
