...
def test_102216(setup_driver):
    """
    102216 验证错误邮箱，无法进行下一步操作-只有点：a.b.c
    1. 打开APP，点击首页"2注册"按钮
    2. 进入Sign Up页面
    3. 邮箱输入错误格式（如：asd.gmail.com）
    4. 勾选隐私政策与用户协议
    5. 点击Next按钮
    ...
    try:
        ...
        # 步骤4: 邮箱输入错误格式 asd.gmail.com
        current_step = "步骤4: 邮箱输入错误格式"
        print(f"🔄 {current_step}")
        try:
            wrong_email = "asd.gmail.com"
        ...
        print("🎉 测试用例102216执行成功！")
        print('✅ 验证错误邮箱（只有点）勾选隐私后点击Next，停留当前页并提示“Please sign up using your email address”')
        time.sleep(2)
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102216_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102216",
            case_desc='102216 验证错误邮箱，无法进行下一步操作-只有点：a.b.c',
            result=case_result,
