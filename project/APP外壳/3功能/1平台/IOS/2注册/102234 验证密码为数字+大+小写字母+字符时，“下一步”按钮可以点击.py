...
def test_102234(setup_driver):
    ...
    try:
        ...
        print("🎉 测试用例102234执行成功！")
        print('✅ 数字+大+小写+字符密码可正常跳转，成功到主页面')
        time.sleep(2)
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102234_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102234",
            case_desc='102234 验证密码为数字+大+小写字母+字符时，“下一步”按钮可以点击',
            result=case_result,
