...
def test_102217(setup_driver):
    """
    102217 验证错误邮箱，无法进行下一步操作-a@b..
    1. 登出确保初始状态；首页点击 Sign Up → 进入注册页
    2. 邮箱输入错误格式 asd@gmail..
    3. 勾选隐私政策/用户协议复选框
    4. 点击 Next
    ...
    try:
        ...
        # 步骤4: 邮箱输入错误格式 asd@gmail..
        current_step = "步骤4: 邮箱输入错误格式"
        print(f"🔄 {current_step}")
        try:
            wrong_email = "asd@gmail.."
        ...
        print("🎉 测试用例102217执行成功！")
        print('✅ 验证错误邮箱 asd@gmail.. 勾选隐私后点击Next，停留当前页并提示“Please sign up using your email address”')
        time.sleep(2)
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102217_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102217",
            case_desc='102217 验证错误邮箱，无法进行下一步操作-a@b..',
            result=case_result,
