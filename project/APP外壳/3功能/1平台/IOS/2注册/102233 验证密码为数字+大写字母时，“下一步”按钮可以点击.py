...
def test_102233(setup_driver):
    """
    102233 验证密码为数字+大写字母时，“下一步”按钮可以点击
    ...
    try:
        ...
        print("🎉 测试用例102233执行成功！")
        print('✅ 数字+大写密码可正常跳转，成功到主页面')
        time.sleep(2)
        ...
        print(f"{'=' * 60}")
        traceback.print_exc()
        save_failure_screenshot(driver, "test_102233_failed")
        ...
        write_report(
            ...
            platform="ios",
            case_id="102233",
            case_desc='102233 验证密码为数字+大写字母时，“下一步”按钮可以点击',
            result=case_result,
