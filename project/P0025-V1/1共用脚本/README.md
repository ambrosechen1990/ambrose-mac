...
- **`report_utils.py`**: 报告工具模块
  ...
  - **报告保存规则**：
    - **P0025-V1**：统一保存在项目根目录 **`P0025-V1/2测试报告/`** 下（每次运行为其子目录：日志、截图、Excel）
    - **其他工程**（P0011、P0024 等）：`配网兼容性/reports/` 或 `1配网兼容性/reports/`
...
- **P0025-V1**：`P0025-V1/2测试报告/<前缀-日期时间>/`（内含 `bluetooth_pairing.log`、`screenshots/`、Excel 报告等）
- **P0011 项目**：`P0011/配网兼容性/reports/`
- **P0024 项目**：`P0024/配网兼容性/reports/`
- **其他项目**：`PXXXX/配网兼容性/reports/`（或 `1配网兼容性/reports/`）
