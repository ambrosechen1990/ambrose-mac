...
MORE_BUTTON_TEXTS = [
    "More",              # English
    "Autres réglages",   # Français
    "Altre impostazioni",# Italiano
    "Weitere Einstellungen",  # Deutsch
    "Más ajustes",       # Español
    "Mais ajustes",      # Português
    "Další nastavení",   # Čeština
    "其他",              # 中文简写
    "更多",              # 中文
    "更多设置",          # 中文变体
]
        ...
        if app_package:
            ...
            for attempt in range(max_retries):
                try:
                    ...
                    for label in MORE_BUTTON_TEXTS:
                        home_xpaths.extend([
                            f'//android.view.View[@content-desc="{label}"]',
                            f'//android.widget.Button[@content-desc="{label}"]',
                            f'//android.view.View[contains(@content-desc,"{label}")]',
                            f'//android.widget.Button[contains(@content-desc,"{label}")]',
                        ])
